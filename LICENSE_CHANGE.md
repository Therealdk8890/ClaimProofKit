...
is authoritative for the current repository and future releases unless a later
version of the project states otherwise.

Daniel Kissel is the sole contributor and copyright holder for the repository's
original and subsequent code. No third-party contributor consent is required
for this relicensing change.

The commercial product boundary is intentionally separate from the library
license. Hosted governance, enterprise operations, managed services, policy
